...
export const getChatForTwoUsers = async (userId1: string, userId2: string): Promise<string> => {
    // const chatMembersList = await chatMembers
...
export const getChatPreview = async (userId: string):Promise<Array<ChatPreview>> => {
